...
function refreshData(node) {
    ...
    $('#data-container').append('<div class="standard-label-text standard-label-text-medium sign-data-bottom-margin">' + node['EntryID'] + ': <a onclick="copyURL(node)"><i class="fas fa-link" id="copyLink"></i></a></div>');
