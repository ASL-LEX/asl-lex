...
let ordered_property_list = ['EntryID', 'LemmaID', 'Code', 'Batch', 'EnglishWF(lg10)',
  ...
  'Iconicity(Z)', 'Iconicity(N)', 'Iconicity_ID', 'D.Iconicity(M)',
  'D.Iconicity(SD)', 'D.Iconicity(N)', 'D.Iconicity(Z)',
  'D.Iconicity(M-native)', 'D.Iconicity(SD-native)',
  'D.Iconicity(Z-native)', 'D.Iconicity(N-native)',
  'GuessConsistency', 'GuessAccuracy', 'Transparency(M)',
  'Transparency SD', 'Transparency Z', 'LexicalClass',
  'Initialized.2.0', 'FingerspelledLoanSign.2.0', 'Compound.2.0',
  'NumberOfMorphemes.2.0', 'SignOnset(ms)', 'SignOffset(ms)',
  'SignDuration(ms)', 'ClipDuration(ms)', 'HandshapeImage', // NOTE: HANDSHAPEIMAGE IS THE IMAGE FOR HANDSHAPE.2.0
