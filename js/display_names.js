...
let ordered_property_list = ['EntryID', 'LemmaID', 'Code', 'Batch', 'SubtLexUSLog10WF',
  ...
  'PercentUnknown(Nonnative)', 'DominantTranslation',
  'PercentGlossAgreement', 'PercentGlossAgreement(Native)',
  'PercentGlossAgreement(Nonnative)', 'NondominantTranslation',
  'Iconicity(M)', 'Iconicity(SD)', 'Iconicity(Z)', 'Iconicity(N)',
  'Iconicity_ID', 'LexicalClass', 'Initialized.2.0',
  ...
  'CDI Semantic Category', 'bglm_aoa', 'empirical_aoa'];

// these are the website display names for all the properties from the csv
let property_display_names = {'bglm_aoa': 'Age Of Acquisition',
  ...
  'H statistic': 'Guess Consistency',
  'PhonotacticProbability': 'Phonotactic Probability',
  'PercentGlossAgreement': 'Dominant Translation Agreement (proportion)',
  'PercentGlossAgreement(Nonnative)': 'Dominant Translation Agreement (Nonnative) (proportion)',
  'DominantTranslation': 'Dominant Translation',
  'PercentUnknown(Nonnative)': 'Sign Unknown (Nonnative) (proportion)',
  ...
  'PercentUnknown(Native)': 'Sign Unknown (Native) (proportion)',
  'PercentGlossAgreement(Native)': 'Dominant Translation Agreement (Native) (proportion)',
  ...
  'NondominantTranslation': 'Nondominant Translations',
  'Spread.2.0': 'Spread'};
